...
//    @Generated(hash = 1554541903)
    @Keep
    public DownInfo(long id, String savePath, long countLength, long readLength,
            int connectonTime, int stateInte, String url, boolean updateProgress,
            String downTiem, String downTitle,String subjectId) {
        this.id = id;
        this.savePath = savePath;
        this.countLength = countLength;
        this.readLength = readLength;
    ...
    public String getDownTiem() {
        return this.downTiem;
    }

    public void setDownTiem(String downTiem) {
        this.downTiem = downTiem;
    }
