 ...
 */
public class LtRvAdapter extends BaseQuickAdapter<HomeBean.DataBean.BbsBean,BaseViewHolder>{

    public LtRvAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, HomeBean.DataBean.BbsBean item) {
        ...
        if (!item.getCount().equals("0")){
            helper.setText(R.id.home_it_talk,item.getCount());
        }else {
            helper.setText(R.id.home_it_talk,"评论");
        }
