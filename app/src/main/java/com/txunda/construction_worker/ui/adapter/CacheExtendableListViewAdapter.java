 ...
 */
public class CacheExtendableListViewAdapter extends BaseExpandableListAdapter {
...
// 获取显示指定分组的视图
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.cache_child_item,parent,false);
