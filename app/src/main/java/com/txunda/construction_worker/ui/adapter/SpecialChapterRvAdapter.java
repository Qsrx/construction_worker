 ...
 */
public class SpecialChapterRvAdapter extends BaseQuickAdapter<ChapterBean.DataBean.ListBean,BaseViewHolder>{

    public SpecialChapterRvAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, ChapterBean.DataBean.ListBean item) {
