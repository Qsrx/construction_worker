 ...
 */
public class DoWorkFgtRvAdapter extends RecyclerView.Adapter<DoWorkFgtRvAdapter.ViewHolder>{
    private List<String> list;
    private List<String> title;
    private Context context;

    public DoWorkFgtRvAdapter(List<String> list, List<String> title, Context context) {
        this.list = list;
        this.title = title;
